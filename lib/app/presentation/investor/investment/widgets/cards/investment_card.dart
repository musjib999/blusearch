...
class InvestmentCard extends StatelessWidget {
  ...
  final double amount;
  final int units;
  const InvestmentCard({Key? key, required this.businessName, required this.image, required this.amount, required this.units}) : super(key: key);
                ...
                Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('$units units', style: GoogleFonts.montserrat(fontSize: 12, fontWeight: FontWeight.w600),),
                        Text('N${numberFormatter(amount)}/unit', style: GoogleFonts.montserrat(fontSize: 8, fontWeight: FontWeight.w500),)
                      ],
                    ),
                  ],
                ),
