          ...
          children: [
            ...
            const Center(
              child:  CircleAvatar(
                ...
                child: Icon(Ionicons.person, color: AppColors.white, size: 40,),
              ),
            ),
            SizedBox(height: 7.sp),
            Center(
              child: Text('Faith Oluwafemi', style: GoogleFonts.montserrat(fontSize: 20, fontWeight: FontWeight.w600),),
            ),
            ...
            ListTile(
              ...
              trailing: const Icon(Icons.arrow_forward_ios, color: AppColors.errorRed,),
            )
          ],
        ),
      ),
