...
class SingleInvestmentSuggestion extends StatelessWidget {
  ...
  static Route route({required InvestmentSuggestionModel investment}) =>
      MaterialPageRoute(
        builder: (_) => SingleInvestmentSuggestion(investment: investment),
      );
  const SingleInvestmentSuggestion({Key? key, required this.investment})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(investment.busniessName),
      ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      RoundedIconButton(
                        ...
                        onTap: () {
                          Navigator.push(context, Message.route(name: investment.busniessName),);
                        },
                      ),
                    ],
                  )
